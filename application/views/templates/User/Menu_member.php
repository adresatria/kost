<nav class="topnavbar navbar-default topnav">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand logo" href="#"><img src="<?php echo base_url();?>assets/image/logo1.png" height="60" width="230" alt="logo"></a>
				</div>	 
			</div>
			<div class="collapse navbar-collapse" id="upmenu">
				<ul class="nav navbar-nav" id="navbarontop">
					<li class="active"><a href="<?php echo base_url()."Welcome/Index_member";?>">BERANDA</a> </li>
					<li class="active"><a href="<?php echo base_url()."Welcome/Info_member";?>">SEPUTAR KOST</a> </li>
